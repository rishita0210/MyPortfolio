...
//         <h1 className="text-5xl lg:text-xl font-bold lilita-one bg-gradient-to-r from-orange-500 to-yellow-400 bg-clip-text text-transparent">
//           My <br /> Projects
//         </h1>
//       </div>
      ...
      <div className="relative w-full h-full overflow-hidden">
        ...
        >
          {projects.map((project) => (
            <div
              key={project.id}
              className="w-48 sm:w-64 md:w-72 flex-shrink-0 bg-gray-900 rounded-lg shadow-lg overflow-hidden snap-center"
            >
              ...
              <div className="p-3">
                ...
                <p className="text-gray-300 text-xs sm:text-sm mt-1">{project.description}</p>

                <a
                  href={project.codeLink}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-orange-500 cursor-pointer hover:text-orange-400 transition-colors mt-3"
                >
                  <FaRegFileCode className="h-4 w-4 sm:h-5 sm:w-5" />
                  <p className="text-xs sm:text-sm font-medium">View Code</p>
                </a>
              </div>
            </div>
          ))}
